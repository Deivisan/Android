...
// 🎯 Configuração
const GROK_LINK = process.argv[2] || 'https://grok.com/share/c2hhcmQtMg_56527f93-9d16-43b7-9a88-52df4b45e012';
const OUTPUT_DIR = path.join(__dirname, 'capturas');
...
(async () => {
  ...
  await page.goto(GROK_LINK, { waitUntil: 'domcontentloaded', timeout: 90000 });
